    ...
    def __init__(self):
        ...
        for suit in ["Clubs", "Diamonds", "Hearts", "Spades"]:
            for card in range(2,15):
                ...
                self.cards[card, suit[0]] = tk.PhotoImage(file="D:\\Dropbox\\CS4780\\Project\\Machine-Learning\\cards_gif\\"+suit[0].lower()+c.getCardOfNum(card).lower()+".gif")
        self.unknownCard = tk.PhotoImage(file="D:\\Dropbox\\CS4780\\Project\\Machine-Learning\\cards_gif\\b2fv.gif")
        ...
        self.backGround = tk.PhotoImage(file="D:\\Dropbox\\CS4780\\Project\\Machine-Learning\\bkg.gif")
