...
pair_features = ['pair ' + str(i) for i in range(11, 17)]
my_preflop_features = pair_features + ['1-high', '2-high']
my_postflop_features = pair_features + ['3-of-a-kind', '5-connected',
                                        '5-suited']
my_river_features = my_postflop_features 
flop_features = [str(i) + '-highest' for i in range(5)] + ['pair']
turn_features = flop_features
